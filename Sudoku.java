...
public class Sudoku {
    ...
    Sudoku() {
        ...
        bottonsPanel.setLayout(new GridLayout(1,9));
        setupBottons();
        ...
        for(int r = 0; r < 9;r++) {
            for(int c = 0; c < 9;c++) {
                ...
                if(tileChar != '-') {
                    ...
                    tile.setBackground(Colour.lightGray);
                }
                else {
                    tile.setFont(new Font("Arial", Font.PLAIN, 20));
                    tile.setBackground(Colour.white);
                }
                    ...
                    tile.setBorder(BorderFactory.createMatteBorder(Color.black));
                }
                ...
                tile.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (numSelected != null){
                            ...
                            if (tileSolution.equals(umSelectedText)) {
    ...
    void setupBottons() {
        for(int i=1; i < 10;i++) {
            ...
            button.addActionListener(new ActionListener() {
                public void actionPerformed(AQctionEvent e) {
